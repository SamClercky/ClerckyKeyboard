...
const uint16_t LAYOUTS[4][30] = {
    ...
    {KEY_1,    KEY_2,    KEY_3,     KEY_4,     KEY_5,     KEY_6,
     KEY_7,    KEY_8,    KEY_9,     KEY_0,     KEYPAD_7,  KEYPAD_5,
     KEYPAD_3, KEYPAD_1, KEYPAD_9,  KEYPAD_0,  KEYPAD_2,  KEYPAD_4,
     KEYPAD_6, KEYPAD_8, KEY_TILDE, KEY_X,     KEY_C,     KEY_V,
     KEY_B,    KEY_N,    KEY_M,     KEY_COMMA, KEY_MINUS, KEY_EQUAL},
    // R layer
    {KEY_F1,
     KEY_F2,
     KEY_F3,
     ...
     KEY_SLASH},
    // RL layer
    {KEY_K, KEY_W, KEY_E, KEY_R,         KEY_T,      KEY_Y,    KEY_U, KEY_I,
     KEY_O, KEY_P, KEY_A, KEY_S,         KEY_D,      KEY_F,    KEY_G, KEY_H,
     KEY_J, KEY_K, KEY_L, KEY_SEMICOLON, KEY_Z,      KEY_X,    KEY_C, KEY_V,
     KEY_B, KEY_N, KEY_M, KEY_COMMA,     KEY_PERIOD, KEY_SLASH},
};
